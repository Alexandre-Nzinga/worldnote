...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd::vault::update_world_description,
            cmd::vault::delete_world,
            cmd::world_transfer::export_world,
            cmd::world_transfer::import_world,
            cmd::library::list_all_cards,
            cmd::library::search_all_cards,
            cmd::library::copy_card_to_world,
            cmd::card::list_card_index,
            cmd::card::search_card_index,
            cmd::card::list_cards,
